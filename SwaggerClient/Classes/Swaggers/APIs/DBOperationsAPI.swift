...
open class DBOperationsAPI: APIBase {
    /**
     ...
     */
    open class func addPost(aPIKey: String, accessToken: String, list: String, body: String, completion: @escaping ((_ data: AddResponse?,_ error: Error?) -> Void)) {
  ...
  "ResponseTime" : 123456789
     ...
     */
    open class func addPostWithRequestBuilder(aPIKey: String, accessToken: String, list: String, body: String) -> RequestBuilder<AddResponse> {
        let path = "/Add"
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func listPost(aPIKey: String, accessToken: String, list: String, body: Body, completion: @escaping ((_ error: Error?) -> Void)) {
     ...
     */
    open class func listPostWithRequestBuilder(aPIKey: String, accessToken: String, list: String, body: Body) -> RequestBuilder<Void> {
        let path = "/List"
        let URLString = SwaggerClientAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func setDelete(aPIKey: String, accessToken: String, list: String, listItemId: String, completion: @escaping ((_ data: SetResponse?,_ error: Error?) -> Void)) {
  ...
  "ResponseTime" : 123456789
     ...
     */
    open class func setDeleteWithRequestBuilder(aPIKey: String, accessToken: String, list: String, listItemId: String) -> RequestBuilder<SetResponse> {
        let path = "/Set"
        let URLString = SwaggerClientAPI.basePath + path
    ...
    /**
     ...
     - parameter completion: completion handler to receive the data and the error objects
     */
    open class func setPost(aPIKey: String, accessToken: String, list: String, listItemId: String, body: String, completion: @escaping ((_ data: SetResponse?,_ error: Error?) -> Void)) {
  ...
  "ResponseTime" : 123456789
     ...
     - returns: RequestBuilder<SetResponse> 
     */
    open class func setPostWithRequestBuilder(aPIKey: String, accessToken: String, list: String, listItemId: String, body: String) -> RequestBuilder<SetResponse> {
        let path = "/Set"
        let URLString = SwaggerClientAPI.basePath + path
        let parameters = body.encodeToJSON() as? [String:AnyObject]
