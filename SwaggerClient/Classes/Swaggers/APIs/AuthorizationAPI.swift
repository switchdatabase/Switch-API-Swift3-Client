...
open class AuthorizationAPI: APIBase {
    /**
     ...
     */
    open class func tokenGet(aPIKey: String, signature: String, expire: Int64, completion: @escaping ((_ data: String?,_ error: Error?) -> Void)) {
     ...
     */
    open class func tokenGetWithRequestBuilder(aPIKey: String, signature: String, expire: Int64) -> RequestBuilder<String> {
        let path = "/Token"
